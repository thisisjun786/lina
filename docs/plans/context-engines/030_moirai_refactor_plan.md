...
2026-09-11 후속 연구는 동일 모델 안에서 역할별 판단 방법을 분화하고 모델별 프롬프트 묶음을 최적화하는 데 집중한다. [연구 근거와 비교 실험](032_moirai_prompt_research.md), [네 역할의 지침 후보](033_moirai_prompt_candidates.md)는 설계 초안이며 런타임 적용과 인지 성능 검증은 아직 수행하지 않았다.
