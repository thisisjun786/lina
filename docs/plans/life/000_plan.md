...
상태: 2026-09-07 전체 구현 진행 중. 이 문서는 구현 순서와 완료 기준을 정한다. 첫 저장·조회·전달 단위는 로컬 구현·검사·독립 리뷰를 통과했다. 두 번째 [세계 편집 단위](020_world_authoring.md)도 구현과 독립 검토를 마쳤다. LIFE 전체 완료를 뜻하지 않는다.
