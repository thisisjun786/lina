...
상태: 2026-09-08 전체 구현 진행 중. 이 문서는 구현 순서와 완료 기준을 정한다. 첫 저장·조회·전달 단위는 로컬 구현·검사·독립 리뷰를 통과했다. [세계 편집 단위](020_world_authoring.md)와 [사회 엔진 단위](030_social_engine.md)도 구현과 독립 검토를 마쳤다. [자율 일상 단위](040_autonomous_life.md)도 구현·독립 검토·전체 검사와 임시 설치본 HTTP 검증을 마쳤다. [업무·기억 연결](050_work_and_persona.md)과 [게시물·상호작용](060_publication.md)도 구현과 독립 재검토를 마쳤다. 게시물까지 포함한 전체 테스트 2,885개와 실제 HTTP 검증 42건이 통과했다. 다음 단위는 070 이미지·프로필 사진 연결이다. LIFE 전체 완료를 뜻하지 않는다.
