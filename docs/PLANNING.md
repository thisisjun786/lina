...
| 모이라이 에이전트 코어 | [목표·세 판단 메커니즘](plans/platform/015_neural_preference_engine_research.md), [판단·선택·학습·실행 계약](plans/platform/016_neural_preference_contract.md), [기존 모듈 구성·전환 초안](plans/platform/017_moirai_module_composition.md), [도메인 경계](plans/context-engines/030_moirai_refactor_plan.md) | 클로토는 미래 성과, 라케시스는 욕구·선호 충족, 아트로포스는 의도·연속성을 각각 추구하는 설계. 원본·사실·권한을 공유하고 목표별 추천은 구분. Senpi LLM·MaleCNS 학습, 모이라이의 목표 충돌 조정·선택 정책과 Host의 검증·기록·실행 인계를 정의. 제품 구현과 판단 효용·회로 성능은 미검증 |
