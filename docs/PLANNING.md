...
| 주기적 프로필 사진과 내부 SNS | [에이전트 일상](plans/platform/010_agent_daily_life_ideas.md), [LIFE 전체 구현 계획](plans/life/000_plan.md) | 내부 게시물·에이전트 답글·댓글·반응·재공유와 다음 경험 연결 구현·검토 통과. 이미지·프로필 사진 연결은 다음 단계. 주기·예산·공유 대상은 명시적 설정 |
