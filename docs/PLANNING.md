...
| 모이라이 에이전트 코어 | [목표·세 판단 메커니즘](plans/platform/015_neural_preference_engine_research.md), [판단·선택·학습·실행 계약](plans/platform/016_neural_preference_contract.md), [기존 모듈 구성·전환 초안](plans/platform/017_moirai_module_composition.md), [도메인 경계](plans/context-engines/030_moirai_refactor_plan.md) | 클로토의 전망·계획, 라케시스의 경험·가치, 아트로포스의 의도·연속성을 같은 개인 상태에서 계산하는 설계. Senpi LLM·MaleCNS 학습을 연결하고 공통 후보 평가·Host 확정·결과 환류를 정의. 제품 구현과 판단 효용·회로 성능은 미검증 |
