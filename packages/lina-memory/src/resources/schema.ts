...
CREATE TABLE resource_jobs (id TEXT PRIMARY KEY,resource_id TEXT NOT NULL REFERENCES resources(id),source_digest TEXT NOT NULL,policy_revision INTEGER NOT NULL,model_settings_revision INTEGER NOT NULL,kind TEXT NOT NULL,data TEXT NOT NULL,UNIQUE(resource_id,source_digest,policy_revision,model_settings_revision,kind)) STRICT;
...
CREATE TABLE resource_derivations (resource_id TEXT NOT NULL REFERENCES resources(id),source_digest TEXT NOT NULL,policy_revision INTEGER NOT NULL,model_settings_revision INTEGER NOT NULL,kind TEXT NOT NULL,data TEXT NOT NULL,PRIMARY KEY(resource_id,source_digest,policy_revision,model_settings_revision,kind)) STRICT;
