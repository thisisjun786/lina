...
export type LifeInputV4 = Omit<LifeInputV1, "version" | "source"> & {
	version: 4;
	source: import("./work-types.ts").ResourceActivitySource;
};
export type LifeInput = LifeInputV1 | LifeInputV2 | LifeInputV3 | LifeInputV4;
